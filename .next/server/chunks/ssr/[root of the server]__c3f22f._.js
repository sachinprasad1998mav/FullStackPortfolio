...
const metadata = {
    ...
    description: "Welcome to my portfolio! I am a Full Stack Developer specializing in building scalable, secure, and user-centric web applications using Java Spring Boot, React, and modern frontend technologies. Explore my projects, skills, and experience.",
    keywords: [
    ...
    authors: [
        {
            name: "Sachin Satish Prasad"
        }
    ],
    creator: "Sachin Satish Prasad",
    openGraph: {
        title: "Sachin Satish Prasad - Full Stack Developer Portfolio",
        description: "Full Stack Developer crafting scalable, performant, and engaging digital experiences using Java Spring Boot and React. Explore my technical skills and projects.",
